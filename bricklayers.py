...
class GCodeSimulator:
    ...
    def _restore_tool_state(self, state):
        ...
        self.z = state.get("z", 0.0)
        self.e = state.get("e", 0.0)
        self.f = state.get("f", 0.0)
        self.retracted = state.get("retracted", 0.0)
        self.width = state.get("width", 0.0)
        self.absolute_positioning = state.get("absolute_positioning", True)
        self.relative_extrusion = state.get("relative_extrusion", False)
